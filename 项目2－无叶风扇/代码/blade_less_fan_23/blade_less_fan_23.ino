...
unsigned char l_word_1[2][4] = {
0x00,0x18,0x10,0x10,0x10,0x10,0x13,0x3B,
};

unsigned char l_word_2[2][4] = {
0x00,0x78,0x40,0x40,0x78,0x08,0x0B,0x7B,
};

unsigned char l_word_3[2][4] = {
0x00,0x78,0x40,0x40,0x78,0x40,0x43,0x7B,
};

unsigned char l_word_4[2][4] = {
0x00,0x48,0x48,0x48,0x78,0x40,0x43,0x43,
};

unsigned char l_word_5[2][4] = {
0x00,0x78,0x08,0x08,0x78,0x40,0x43,0x7B,
};
unsigned char l_word_6[2][4] = {
0x00,0x78,0x08,0x08,0x78,0x48,0x4B,0x7B,
};
unsigned char l_word_7[2][4] = {
0x00,0x78,0x40,0x40,0x40,0x40,0x43,0x43,
};
unsigned char l_word_8[2][4] = {
0x00,0x78,0x48,0x48,0x78,0x48,0x4B,0x7B,
};
unsigned char l_word_9[2][4] = {
0x00,0x78,0x48,0x48,0x78,0x40,0x43,0x7B,
};
...
unsigned int last_time_Temperature = 260;
...
void UpdateDisplayInfo(int _com){
  if (_com == 0){
    ...
    last_time_Temperature = Temperature;
...
void execute_Tem_Display_Command(){
    /*
    Serial.println(Temperature/100);
    Serial.println((Temperature-Temperature/100*100)/10);
    Serial.println(Temperature-Temperature/10*10);
    */
    //tm1637.set(BRIGHT_TYPICAL);
    //tm1637.display(0,NumTab[Temperature/100]);
    //tm1637.point(POINT_ON);
    //tm1637.display(1,NumTab[(Temperature-Temperature/100*100)/10]);
    //tm1637.point(POINT_OFF);
    //tm1637.display(2,NumTab[Temperature-Temperature/10*10]);    
    //tm1637.display(3,NumTab[16]);
    if (last_time_Temperature != Temperature){
...
void update_Temperature_info(){
  ...
  switch (int(Temperature-Temperature/100*100)/10){
    ...
    case 1:
      for(j = 0 ; j <2  ; j++){
        for(k =  0; k < 4 ; k++){
            Display_word_shifenwei[j][k] = l_word_1[j][k];
        }
      }
      break;
    case 2:
      for(j = 0 ; j <2  ; j++){
        for(k =  0; k < 4 ; k++){
            Display_word_shifenwei[j][k] = l_word_2[j][k];
        }
      }
      break;
    case 3:
      for(j = 0 ; j <2  ; j++){
        for(k =  0; k < 4 ; k++){
            Display_word_shifenwei[j][k] = l_word_3[j][k];
        }
      }
      break;
    case 4:
      for(j = 0 ; j <2  ; j++){
        for(k =  0; k < 4 ; k++){
            Display_word_shifenwei[j][k] = l_word_4[j][k];
        }
      }
      break;
    case 5:
    ...
    case 6:
      for(j = 0 ; j <2  ; j++){
        for(k =  0; k < 4 ; k++){
            Display_word_shifenwei[j][k] = l_word_6[j][k];
        }
      }
      break;
    case 7:
      for(j = 0 ; j <2  ; j++){
        for(k =  0; k < 4 ; k++){
            Display_word_shifenwei[j][k] = l_word_7[j][k];
        }
      }
      break;
    case 8:
      for(j = 0 ; j <2  ; j++){
        for(k =  0; k < 4 ; k++){
            Display_word_shifenwei[j][k] = l_word_8[j][k];
        }
      }
      break;
    case 9:
      for(j = 0 ; j <2  ; j++){
        for(k =  0; k < 4 ; k++){
            Display_word_shifenwei[j][k] = l_word_9[j][k];
        }
      }
      break;
    case 0:
